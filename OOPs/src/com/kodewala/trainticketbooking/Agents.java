...
public class Agents implements TicketBooking{
	...
	System.out.println("Searching for the trai+n with "+trainNumber+"journey started from"+ startLocation +" to "+ endLocation);
